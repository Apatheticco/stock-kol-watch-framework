...
**🅱️ 模式跳过**：Step 0 的 vault 扫描、Step 5.6/5.6.5（除非用户当场喂实盘/卖方）、Step 10 全部落盘、Step 10.2 合并协议、Step 10.8 校准、Step 10.9 收尾门禁、Step 10.95 完整性审查、`_last-pull` 更新、周报、归档。
...
- 一天可多次拉取（晨/盘中/盘后），**都更新同一份日报**（见 Step 10.2 合并协议）。
